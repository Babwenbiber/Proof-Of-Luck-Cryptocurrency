...
find_path (SGXSDK_INCLUDE_DIRS
        ...
        /ibr/local/lib/intel/sgxsdk/include)
...
find_path (ENCL_C_INCLUDE_DIRS
        ...
        /ibr/local/lib/intel/sgxsdk/include/tlibc
        NO_DEFAULT_PATH
...
find_path (ENCL_CXX_INCLUDE_DIRS
        ...
        /ibr/local/lib/intel/sgxsdk/include/libcxx
        NO_DEFAULT_PATH
        NO_SYSTEM_ENVIRONMENT_PATH)
...
find_library (SGXSDK_URTS_SIM
        ...
        /ibr/local/lib/intel/sgxsdk/lib64
        ENV LIBRARY_PATH
        ENV LD_LIBRARY_PATH)

find_library (SGXSDK_UAE_SERVICE_SIM
        NAMES
        sgx_uae_service_sim
        PATHS
        /usr/lib
...
find_program (SGXSDK_EDGER8R
        ...
        /ibr/local/lib/intel/sgxsdk/bin/x64)
...
SET(CMAKE_REQUIRED_LIBRARIES sgx_urts sgx_urts_sim sgx_trts sgx_trts_sim)
...
mark_as_advanced(SGXSDK_INCLUDE_DIRS SGXSDK_ENCL_C_INCLUDE_DIRS SGXSDK_ENCL_CXX_INCLUDE_DIRS SGXSDK_URTS SGXSDK_URTS_SIM SGXSDK_TRTS SGXSDK_TRST_SIM) #ELF_GETSHDRSTRNDX)
